classdef MOSFET_app_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function results = mosfet_calculator1(app, p, Vgs_set, Vds_sweep)
                ...
                Vgs_map = linspace(0, max(Vgs_set), 500);
                Vds_map = linspace(0, max(Vds_sweep), 500);
    ...
    methods (Access = private)
        ...
        function RunSweepButtonPushed2(app, event)
            ...
            % ---- input validation ----
            if isempty(Vgs_set)
                uialert(app.UIFigure,'Invalid VGS input.','Input Error')
                return
            end

            % === 4. Call calculator ===
           
            results = app.mosfet_calculator1(p, Vgs_set, Vds_sweep);
            app.results = results;
            ...
            cla(app.UIAxes_4)
            plot(app.UIAxes_4, trace,'LineWidth',2)
            set(app.UIAxes_4,'YScale','log')
            grid(app.UIAxes_4, 'on')
            xlabel(app.UIAxes_4, 'Iteration')
            ylabel(app.UIAxes_4, 'Error')
            ...
            switch choice
                ...
                case 'CSV'
                    ...
                    elseif tab == app.ConvergenceTab
                        ...
                        writetable(T, [filename 'convergence.csv'])
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.TextArea_2.Value = {'Press Run Sweep Button to Generate Plots'};
